// See https://lastminuteengineers.com/esp32-dht11-dht22-web-server-tutorial/
#include <WiFi.h>
#include <WebServer.h>
#include "DHT.h"
...
String SendHTML(float temperatureStat,float humidityStat,float heatIndexStat){
    ...
    ptr +="</svg>\n";
    ptr +="</div>\n";
    ptr +="<div class=\"side-by-side temperature-text\">Heat Index</div>\n";
    ptr +="<div class=\"side-by-side temperature\">";
